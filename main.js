...
//global.db = new Low(new mongoDB('mongosh "mongodb+srv://cluster0.mllpzk3.mongodb.net/myFirstDatabase" --apiVersion 1 --username Zulfikar Bot'))
...
async function connectionUpdate(update) {
  ...
  //if (update.receivedPendingNotifications) conn.sendMessage(`6282279425257@s.whatsapp.net`, {text: '♨︎O̳K̳ B̳O̳T̳ B̳E̳R̳H̳A̳S̳I̳L̳ T̳E̳R̳H̳U̳B̳U̳N̳G̳' })
}
