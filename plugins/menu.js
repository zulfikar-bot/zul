...
╟👨‍👨‍👧‍👧*𝐒𝐚𝐫𝐚𝐧𝐠𝐁𝐨𝐭:*
╟https://chat.whatsapp.com/JbWKDM8dM462QUlDwKKs8m
╚»★★ミ✧･ﾟ: ✧ﾟ･:
    ...
    text = text.replace(new RegExp(`%(${Object.keys(replace).sort((a, b) => b.length - a.length).join`|`})`, 'g'), (_, name) => '' + replace[name])
     ...
     templateMessage: {
         hydratedTemplate: {
           ...
           hydratedButtons: [{
             urlButton: {
               displayText: '✏️ Z̺͆u̺͆l̺͆f̺͆i̺͆k̺͆a̺͆r̺͆ ̺͆Y̺͆T',
               url: 'https://www.youtube.com/channel/UCmQZpk5P_0-8dGR6I5bwT7w'
             }
