    ...
    switch (command) {
       ...
       //     if (!room) throw 'Kamu tidak sedang berada di anonymous chat\nKetik #start\nKetik /start\nKetik !start'
        ...
        case 'start': {
            ...
            if (room) {
             //   this.send2Button(room.a, 'Menemukan partner!', '© Zulfikar Bot', 'Next Partner..', '/skip', 'Stop..', '/stop', m)
                this.reply(room.a, 'Menemukan partner!', m)
                room.b = m.sender
                room.state = 'CHATTING'
                //this.send2Button(room.b, 'Menemukan partner!', '© Zulfikar Bot', 'Next Partner..', '/skip', 'Stop..', '/stop', m)
